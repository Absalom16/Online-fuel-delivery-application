...
<div class="col-sm-8">
<h2 class="text-center" style="color: black;">These are the registered users</h2>
<p>
<?php
try {
 ...
 $query = "SELECT first_name, last_name, email, phone_number,user_level, "; // #5
...
<td>' . $registration_date . '</td>
 ...
 if ($current_page != 1) {
 $echostring .=
 '<a href="admin-view-users.php?s=' . ($start - $pagerows) .
 '&p=' . $pages . '">Previous</a> ';
 }
