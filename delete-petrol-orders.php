...
// From view_users.php
 ...
 mysqli_stmt_prepare($q, 'DELETE FROM petrol_orders WHERE order_id=? LIMIT 1');
 ...
 $query .= "petrol_orders WHERE order_id=?";
...
<form action="delete-petrol-orders.php" method="post"
