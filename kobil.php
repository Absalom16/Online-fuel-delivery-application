...
<h2>PETROL ORDERS</h2>
		...
		<form method='get' action='petrol-vendors-order-db.php'>
			<select name='order_id'>
				<?php
					$query=mysqli_query($dbcon,'select * from petrol_orders where company="Kenol kobil"');
...
?> 
		...
		<form method='get' action='diesel-vendors-order-db.php'>
			<select name='order_id'>
				<?php
					$query=mysqli_query($dbcon,'select * from diesel_orders  where company="Kenol kobil"');
