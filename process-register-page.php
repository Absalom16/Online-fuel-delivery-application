...
if(empty($phone_number)){
    ...
    //check for a password and match against the confirmed password:
        ...
        //make the query:
        $query="INSERT INTO users (user_id, first_name, last_name,email,phone_number,password,registration_date)";
    ...
    mysqli_stmt_bind_param($q, 'sssss',  $first_name, $last_name, $email ,$phone_number ,$password );
    //execute query
