...
<section class="food_section layout_padding-bottom">
    <div class="container">
      ...
      <div class="filters-content">
        ...
        <!--shell-->
          <div class="col-sm-4 col-lg-5 all shell">
            <div class="box">
              <div>
                <div class="img-box">
...
?>
<h2>PETROL ORDERS</h2><br>
        Select invoice:
<form method='get' action='petrol-vendors-order-db.php'>
			<select name='order_id'>
				<?php
					$query=mysqli_query($dbcon,'select * from petrol_orders where company="Rubis"');
					while($petrol_orders=mysqli_fetch_array($query)){
						echo "<option value='".$petrol_orders['order_id']."'>".'Name:'.$petrol_orders['gas_station']. "  Order date:" .$petrol_orders['order_date']."</option>";
					}
				?>
			</select>
          ...
          <div class="col-sm-6 col-lg-5 all shell">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/rubis.jpg" alt="">
...
?> 
		...
		<form method='get' action='diesel-vendors-order-db.php'>
			...
			<?php
					$query=mysqli_query($dbcon,'select * from diesel_orders  where company="Rubis"');
					while($diesel_orders=mysqli_fetch_array($query)){
						echo "<option value='".$diesel_orders['order_id']."'>". 'Name:'.$diesel_orders['gas_station']. "Order date:".$diesel_orders['order_date']. "</option>";
					}
				?>
			</select>
			<input type='submit' value='Generate'>
