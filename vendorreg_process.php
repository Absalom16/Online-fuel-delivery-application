...
if(empty($account_no)){
    ...
    //check for a password and match against the confirmed password:
        ...
        //make the query:
        $query="INSERT INTO vendors (vendor_id, name,email,phone_number,account_no,password,registration_date)";
    ...
    mysqli_stmt_bind_param($q, 'sssss',  $name, $email ,$phone_number ,$account_no,$password );
    //execute query
